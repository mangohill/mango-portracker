...
// $ Impact is shown first (the more actionable "what actually moved your
// balance" number), % Move below it (useful colour, but less relevant to
// your total than the dollar figure sitting above it).
