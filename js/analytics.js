...
// Owns its own cache reset (called by invalidatePriceCaches() in helpers.js
// by name, and defensively at the top of renderAnalytics() below) rather
// than having another file reach in and null this variable directly.
...
function renderAnalytics(){
  resetAnalyticsPriceCache(); // pfSnapshots may have changed since last render — savePfSnapshots() already invalidates this on every actual mutation; this is a harmless redundant safety net
