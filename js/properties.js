...
function buildSyncPayload(){
  ...
  return {
    ...
    data: {
      ...
      pt_price_cutoff: (()=>{try{return JSON.parse(localStorage.getItem('pt_price_cutoff')||'{}');}catch(e){return {};}})(),
...
function applyRemoteData(remote){
  ...
  // so a remote payload synced before the CGT cutoff-key rename still applies correctly.
  ...
  try { onDataChanged(); } catch(e){} // defensive — mergePfSnapshots() above already invalidates the pfSnapshots-derived caches via savePfSnapshots()
